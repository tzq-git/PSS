...
<html>
	...
	<body>
		<article class="page-container">
			<form class="form form-horizontal" id="objForm" action="SaleReturn"
				  method="post">
				<input type="hidden" name="oper" value="updateDeal"/>
				<input type="hidden" name="id" value="${returnId}" />
				<input type="hidden" name="orderId" value="${returnId}" />
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*
</span>退货单号</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${returnId}"
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text"
							   value="<fmt:formatDate value="${returnDate}" pattern="yyyy-MM-dd hh:mm:ss"/>"
							   onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss' })"
							   placeholder="" id="returnDate" name="returnDate">
					</div>
				</div>
				<div class="row cl">
