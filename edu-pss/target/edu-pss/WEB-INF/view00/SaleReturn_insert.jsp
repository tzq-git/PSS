...
<html>
	...
	<body>
		<article class="page-container">
			<form action="SaleReturn" class="form form-horizontal" id="objForm">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${returnId}"
							   placeholder="" id="returnId" name="returnId">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="datetime" class="input-text"
							   value="<fmt:formatDate value="${returnDate}" pattern="yyyy-MM-dd"/>"
