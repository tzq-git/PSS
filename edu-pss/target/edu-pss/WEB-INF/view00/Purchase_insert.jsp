...
<head>
    ...
    <meta name="keywords" content="购入管理">
    <meta name="description" content="购入管理">
</head>
<body>
<article class="page-container">
    <form action="Purchase" class="form form-horizontal" id="objForm">
        <input type="hidden" name="oper" value="insertDeal" />
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>购入单号：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${purchaseId}"
                       placeholder="" id="purchaseId" name="purchaseId">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>购入日期：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${buyDate}"
                       placeholder="" id="buyDate" name="buyDate">
            </div>
        </div>
        <div class="row cl">
