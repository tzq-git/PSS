...
<html>
	...
	<body>
		<article class="page-container">
			<form class="form form-horizontal" id="objForm" action="User"
				  method="post">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${userId}"
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${userName}"
							   placeholder="" id="userName" name="userName" disabled="true">
					</div>
				</div>
				<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*
