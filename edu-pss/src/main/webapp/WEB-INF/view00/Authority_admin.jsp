...
<div class="layui-fluid">
    <div class="layui-row">
        <form action="Authority?oper=updateDeal" method="post"  class="layui-form layui-form-pane">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <table class="layui-table layui-input-block">
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" name="Data" value="${Data}" lay-skin="primary" lay-filter="father"
                                   title="资料管理">
                            <div class="layui-unselect layui-form-checkbox" lay-skin="primary"><span>资料管理</span><i
                    ...
                    <tr>
                        <td>
                            ...
                            <input name="Purchase" lay-skin="primary" type="checkbox"
                                   value="${Purchase}" title="采购管理" lay-filter="father">
                            <div class="layui-unselect layui-form-checkbox" lay-skin="primary"><span>采购管理</span><i
                                    class="layui-icon layui-icon-ok"></i></div>
                        </td>
                        <td>
                            <div class="layui-input-block">
                    ...
                    <tr>
                        <td>
                            ...
                            <input name="Sale" lay-skin="primary" type="checkbox"
                                   value="${Sale}" title="销售管理" lay-filter="father">
                            <div class="layui-unselect layui-form-checkbox" lay-skin="primary"><span>销售管理</span><i
                                    class="layui-icon layui-icon-ok"></i></div>
                        </td>
                        <td>
                            <div class="layui-input-block">
            ...
            <div class="layui-form-item">
                <button class="layui-btn" onclick="Checks()" lay-filter="add">提交</button>
            </div>
...
<script>
    ...
    $(function () {
        var checkboxs = $('input[type=checkbox][value="1"]');
        $.each(checkboxs, function () {
            $(this).attr("checked",true);
        });
    });
